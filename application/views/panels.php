...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo base_url()?>index.php/Admin/widget/widgets"><em class="fa fa-calendar">&nbsp;</em> Widgets</a></li>
			<li><a href="<?php echo base_url()?>index.php/Admin/chart/charts"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="<?php echo base_url()?>index.php/Admin/element/elements"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>
			<li class="active"><a href="<?php echo base_url()?>index.php/Admin/panel/panels"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
