		...
		<table class="table table-hover">
				...
				<tbody>
					...
					foreach ($wisma_list as $row) {
						...
						echo "<a href='".base_url()."index.php/pegawai/update/".$row['id_wisma']."' class='btn btn-success'>Update</a>";
						echo " ";
						echo "<a href='".base_url()."index.php/pegawai/delete/".$row['id_wisma']."' class='btn btn-danger'>Hapus</a>";
						echo "</td></tr>";
					}
